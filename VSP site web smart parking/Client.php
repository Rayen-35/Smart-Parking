...
<head>
    <link rel="stylesheet"
  type ="text/css" href ="Client.css" media="screen" />
...
<?php include 'nav.php' ?>
    <div class="banner">
      <img src ="bleu bilfazett.png" alt="image" height ="170" width="20%"><font color ="gray"><h1><u>Les clients</u></h1></font>
    </div>
          <br><br> <hr><br><br>
          <font color="black" size ="6" face="normal" > <p align ="center"><u>Les clients :</u></p> </font>
  ...
  <?php
    ...
    <tr>
      ...
      <td><?php echo $pp['nom'] ?></td>
      <td><?php echo $pp['prénom'] ?></td>
